...
class ProductionOrderController extends Controller
{
    ...
    // UPDATED: Store method now validates against SAP API instead of pro_order table
    ...
    // Fetch pro_order data from SAP API with optional date filtering
        ...
        try {
            ...
            $transformedOrders = $proOrders->map(function($order) {
                return [
                    ...
                    'batch' => $order['BatchNo'] ?? null,
                    'order_quantity' => $order['QtyPro'] ?? null,
